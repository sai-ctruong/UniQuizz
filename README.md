...
_Hoặc đăng ký tài khoản mới miễn phí!_
...
_Trang chủ với theme Tết Việt Nam, hiệu ứng hoa mai rơi và CTA rõ ràng_
...
_Quản lý quiz cá nhân với tính năng tìm kiếm, chia sẻ và dark mode_
...
_Giao diện Quiz sống động tạo cảm giác "muốn học"_
...
_Trợ lý AI Miku với Live2D character, chat thông minh và TTS_
...
_Tạo và học flashcard với giao diện thân thiện, hỗ trợ nhiều chủ đề_
...
- **GitHub**: [https://github.com/sai-ctruong/UniQuizz.git](https://github.com/sai-ctruong/UniQuizz.git)
